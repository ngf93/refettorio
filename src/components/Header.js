...
import { NavDropdown, Offcanvas, CloseButton } from "react-bootstrap"
        ...
        <>
                ...
                <div className="container">
                    ...
                    <div className='flex-1'>
                        <div className='d-flex justify-content-between align-items-center fs-11'>
                            ...
                            <button type='button' onClick={()=>setMobileMenu(true)} className='btn-menu d-lg-none'>
            ...
            <Offcanvas show={mobileMenu} onHide={()=>setMobileMenu(false)}>
                <Offcanvas.Body>
                    ...
                    <div className="d-flex align-items-center mb-3">
                        <img src="/images/icons/schedule.svg" alt="расписание" className='icon'/>
                        <span className="fs-13 ms-2">Ежедневно с 10:00 до 23:00</span>
                    </div>
                    <a href="tel:+78432920292" className='d-block d-lg-flex align-items-center'>
                        <img src="/images/icons/call.svg" alt="звонок" className='icon'/>
                        <span className="fs-13 ms-2">+7 (843) 292-0-292</span>
                    </a>
                ...
                <CloseButton aria-label="Hide" onClick={()=>setMobileMenu(false)} className="position-absolute top-1 right-1"/>
            </Offcanvas>
        </>
    );
})
